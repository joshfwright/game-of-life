...
{   
    ...
    if(gameData == NULL)
    {
        printf("Could not find or open Game of Life data file 'gameData.txt'\n\n");
        printf("Be sure you include the data file name after the program name.\n");
        printf("For example, to run Game of Life graphical version, you would type: ./golgfx gameData.txt\n\n");
        exit(1); 
    }         
...
void DisplayProgramFooter(int cellGrid[MAX_ROWS][MAX_COLS], int stepCount)
{
    ...
    printf("|*********************************************|\n");
    printf("|                                             |\n");     
    printf("|-- BE SURE TO ENLARGE YOUR TERMINAL WINDOW --|\n");
    printf("|                                             |\n");        
